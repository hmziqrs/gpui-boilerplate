            ...
            .child(
                v_form()
                    ...
                    .child(
                        field()
                            .label(crate::i18n::localize_message(
                                &RegistrationFormLabelVariants::Password,
                            ))
                            .required(true)
                            .description_fn({
                                let error = error_for("password");
                                let description = crate::i18n::localize_message(
                                    &RegistrationFormDescriptionVariants::Password,
                                );
                                move |_, _| {
                                    div()
                                        .flex()
                    ...
                    .child(
                        field()
                            .label(crate::i18n::localize_message(
                                &RegistrationFormLabelVariants::Phone,
                            ))
                            .required(true)
                            .description_fn({
                                let error = error_for("phone");
                                let description = crate::i18n::localize_message(
                                    &RegistrationFormDescriptionVariants::Phone,
                                );
                                move |_, _| {
                                    div()
                                        .flex()
                    ...
                    .child(
                        field()
                            .label(crate::i18n::localize_message(
                                &RegistrationFormLabelVariants::Website,
                            ))
                            .description_fn({
